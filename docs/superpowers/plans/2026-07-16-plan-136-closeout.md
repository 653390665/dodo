...
> **Status (2026-08-17): DONE.** Navigation wiring and cold-start relationship states are implemented and covered by the focused relationship regression included in the `49/49` frontend result. Original checkboxes are retained as historical steps.

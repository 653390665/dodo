...
> **Status (2026-08-17): DONE.** Relationship CRUD, real navigation, empty-state branching, edge labels, shared filtering, and focused tests are implemented. The 2026-08-17 focused frontend regression passed as part of `49/49`; original checkboxes are retained as historical steps.

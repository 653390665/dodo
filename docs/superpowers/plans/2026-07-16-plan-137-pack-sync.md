...
> **Status (2026-08-17): DONE.** Extraction preview, explicit confirmation, transactional world sync, refresh, idempotency, isolation, and rollback behavior are implemented. The 2026-08-17 isolated Node regression passed as part of `65/65`; original checkboxes are retained as historical steps.

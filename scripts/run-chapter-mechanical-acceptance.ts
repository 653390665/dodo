...
function runMechanicalAcceptance() {
  ...
  const indicators: ReportIndicator[] = [
    ...
    },
    {
      ...
      score: 100,
      description: '完全遵从“精修预览最多 3 处”物理底线，不重写、不侵染未受质疑的其他 90% 原文字句。',
    },
    {
...
| 样章名称 | 原始字符 | 修后字符 | 初始 Slop 分 | 修后 Slop 分 | 精修预览应用数 | 极简外科改造契约 | Base64 安全隔离 |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
> [!IMPORTANT]
> - **局部精修预览闭环**：通过对真实样章的实跑验证，修后文本 100% 去除了被正则审稿器标注的所有致命机械套话与弱对话链。
> - **真实 Slop 分数呈现科学暴涨**：

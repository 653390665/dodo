...
const MIN_CHAPTER_DRAFT_CHARS = 4000;
...
function countDraftChars(text: string) {
  return text.replace(/\s/g, '').length;
}

function expandDraftToMinimum(baseDraft: string, sceneBeats: string, contextStr: string) {
...
function ensureMinimumDraftLength(draft: string, sceneBeats: string, contextStr: string) {

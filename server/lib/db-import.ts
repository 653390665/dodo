...
export const ALLOWED_IMPORT_INDEXES = new Map<string, { tableName: string; columns: string[]; unique?: boolean; predicate?: string }>([
...
export const EXPECTED_IMPORT_FOREIGN_KEYS = new Map<string, Array<{
  from: string;
  parentTable: string;
  to: string;

...
export const PROMPT_GOVERNANCE_CATALOG: GovernedPromptAsset[] = [
  ...
  },
  {
    ...
    "title": "一键生成章节梗概",
    "stage": "polish",
    "goal": "发挥广场精品提示词 一键生成章节梗概 局部润色、对白动作强化或题材契合度。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  {
    "id": "square-94",
    "title": "长篇一键破解爆款小说并生成脑洞",
    "stage": "polish",
    "goal": "发挥广场精品提示词 长篇一键破解爆款小说并生成脑洞 局部润色、对白动作强化或题材契合度。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "一键破解爆款并生成脑洞",
    "stage": "polish",
    "goal": "发挥广场精品提示词 一键破解爆款并生成脑洞 局部润色、对白动作强化或题材契合度。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "一键润色降ai 1.0",
    "stage": "polish",
    "goal": "发挥广场精品提示词 一键润色降ai 1.0 局部润色、对白动作强化或题材契合度。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "一键融梗换心",
    "stage": "polish",
    "goal": "利用定制付费资产 一键融梗换心 全链路推进长篇正文或提供题材适配。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "一键润色降ai 2.0",
    "stage": "polish",
    "goal": "利用定制付费资产 一键润色降ai 2.0 全链路推进长篇正文或提供题材适配。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "番茄评分卡",
    "stage": "planning",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载 番茄评分卡 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "stage": "polish",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载 章末钩子 13 式 + 章首 7 式 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "拆书 6 阶段 SOP",
    "stage": "planning",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载 拆书 6 阶段 SOP 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "黄金三章诊断",
    "stage": "planning",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载 黄金三章诊断 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "雪花六步法",
    "stage": "planning",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载 雪花六步法 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "章节正文写作 prompt",
    "stage": "drafting",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载 章节正文写作 prompt 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "角色状态文档",
    "stage": "planning",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载 角色状态文档 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "去 AI 味指南",
    "stage": "polish",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载 去 AI 味指南 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "开头模板库",
    "stage": "planning",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载 开头模板库 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "八节点结构",
    "stage": "planning",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载 八节点结构 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "情绪拉扯五折线",
    "stage": "polish",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载 情绪拉扯五折线 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "爽点核心公式",
    "stage": "planning",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载 爽点核心公式 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "stage": "planning",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载  写前 Brief Agent 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": " +  审稿 schema v2",
    "stage": "review",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载  +  审稿 schema v2 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "节奏拆书卡",
    "stage": "planning",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载 节奏拆书卡 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",
  ...
  },
  {
    ...
    "title": "钩子拆书卡",
    "stage": "planning",
    "goal": "结合番茄与 Webnovel 的特色能力，挂载 钩子拆书卡 提高完读率和开篇爽点。",
    "inputs": [
      "content"
    ],
    "template": "",

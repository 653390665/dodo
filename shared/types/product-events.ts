export const PRODUCT_EVENT_NAMES = [
  ...
  'deconstruction_card_stack',
  'deconstruction_card_unstack',
  'deconstruction_card_skip',
  'deconstruction_card_trial',
  'deconstruction_card_restore',
  'capability_view',
  'capability_assemble',
  'capability_preview',
  'capability_apply',
  ...
  'capability_stale',
  'capability_return',
  'capability_artifact_accept',
  'capability_viewed',
  'technique_favorited',
  'skill_card_added',
  'skill_deck_applied',
  'capability_config_cancelled',
  'fusion_previewed',
  'fusion_saved',
  'chapter_overlay_used',
  'diagnostic_run',
  'capability_returned_to_editor',
  'technique_used',
  'capability_package_expanded',
  'capability_package_component_selected',
  'capability_package_result_launched',
  'generation_entry_used',
  'generation_retry_self_served',
  'first_chapter_accepted',
] as const;
export type ProductEventName = (typeof PRODUCT_EVENT_NAMES)[number];

export const PRODUCT_EVENT_STAGES = [
  'import',
  'review',
  'sync',
  'planning',
...
export type ProductEventSourceType =
  'built-in' | 'plaza' | 'licensed' | 'book-extracted' | 'unknown';
...
export interface ProductEventMetrics {
  ...
  rates: {
    previewAcceptance: RateMetric;
    syncCompletion: RateMetric;
    criticUnknown: RateMetric;
    conflict: RateMetric;
  };

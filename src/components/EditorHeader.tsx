    ...
    >
      <div className="flex items-center gap-4 min-w-0">
        ...
        <div className="flex flex-col min-w-0">
          <label htmlFor="chapter-volume-name" className="sr-only">
            所属卷
          </label>
          <input
      ...
      <div className="flex items-center gap-2 min-w-0 shrink-0">
          ...
          <div className="hidden xl:flex items-center gap-2 min-w-0">
            ...
            >
              ...
              {capabilitySummaryText && (
                <span className="shrink-0 font-bold text-theme-text">{capabilitySummaryText}</span>
              )}
        ...
        <Tooltip>
          ...
          <TooltipContent side="bottom">智能管家</TooltipContent>
        </Tooltip>
        <Tooltip>
          <TooltipTrigger asChild>
            <button
        ...
        <Tooltip>
          ...
          <TooltipContent side="bottom">模型与系统设置</TooltipContent>
        </Tooltip>
      </div>
    </div>
  );

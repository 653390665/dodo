                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-theme-border text-xs font-bold text-theme-text hover:bg-theme-sidebar/40 transition-colors"
                      >
                        <RotateCcw size={14} />
                        恢复默认
                      </button>

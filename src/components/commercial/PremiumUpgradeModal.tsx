...
export function PremiumUpgradeModal() {
  ...
  const [limitType, setLimitType] = useState<'extractSkill' | 'generateProse' | 'advancedAudit'>(
    'extractSkill'
  );
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-zinc-950/70 backdrop-blur-md animate-fade-in">
      ...
      <div
        ...
        style={{
          boxShadow:
            '0 0 80px -10px oklch(65% 0.25 280 / 0.15), 0 0 40px -20px oklch(70% 0.3 340 / 0.1)',
        }}
      >
        {/* 关闭按钮 */}
        <button
        ...
        <div className="flex-1 overflow-y-auto space-y-6 pr-1">
          ...
          <div className="flex items-start gap-4 pb-4 border-b border-white/5">
            <div
              ...
              style={{
                background:
                  'linear-gradient(135deg, oklch(65% 0.25 280 / 0.15), oklch(70% 0.3 340 / 0.15))',
              ...
              {isPackageGate ? (
                <>
                  <div className="flex items-center gap-2">
                    <span className="px-2 py-0.5 rounded bg-purple-500/10 border border-purple-500/20 text-[10px] text-purple-400 font-bold tracking-wider">
                      内测增强能力
                    </span>
                  ...
                  <p className="text-xs text-zinc-400 leading-relaxed">{packageDesc}</p>
                </>
              ) : (
                <>
                  <div className="flex items-center gap-2">
                    <span className="px-2 py-0.5 rounded bg-amber-500/10 border border-amber-500/20 text-[10px] text-amber-400 font-bold tracking-wider">
                      配额超限
                    </span>
                  ...
                  <p className="text-xs text-zinc-400">
                    当前累计消耗额度：<span className="text-amber-400 font-bold">{count}</span> /{' '}
                    {max} 次
                  </p>
                </>
              )}
              ...
              <table className="w-full text-left border-collapse text-xs">
                <thead>
                  <tr className="bg-white/5 text-zinc-300 border-b border-white/5 font-bold">
                    ...
                    <th className="p-3.5" style={{ color: 'oklch(70% 0.3 340)' }}>
                      说明
                    </th>
                  </tr>
                </thead>

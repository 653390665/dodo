...
export async function listChapterProductionRunBadges(novelId: string): Promise<ChapterProductionRunBadge[]> { return call('listChapterProductionRunBadges', novelId); }

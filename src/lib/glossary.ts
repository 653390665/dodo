 ...
 */
export const GLOSSARY: ReadonlyArray<{
  term: string;
  ...
  {
    term: '能力卡',
    replaces: ['技能', '拆书卡', '结构卡', '职责卡'],
    note: '能力中心/商店里的一切可启用卡片统称能力卡',
  },
  {
    term: '常用技法',
    replaces: ['技法', '偏好技法'],
    note: '启用后写入 favoriteTechniqueIds 的卡',
  },
  { term: '写法确认', replaces: [], note: '专有流程名，保留（写法确认留存化依赖其语义）' },
  {
    term: '质量标准',
    replaces: ['系统护栏', '护栏增强'],
    note: '003 起护栏不再上货架，统一叫质量标准面板',
  },
  { term: '创作流程', replaces: ['流程', '技能系列'], note: 'SKILL_SERIES_FLOWS 的对外名称' },
  {
    term: '质量报告',
    replaces: ['AI 审稿报告', '审稿标签'],
    note: '002 起完成审查结论的唯一查看面',
  },
];

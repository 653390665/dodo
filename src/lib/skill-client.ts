...
export async function getSkill(id: string): Promise<Skill | undefined> {
  return call('getSkill', id);
}
export async function createSkill(s: Skill): Promise<void> {
  return call('createSkill', s);
}
export async function createSkillsBatch(skills: Skill[]): Promise<void> {
  return call('createSkillsBatch', skills);
}
...
export async function deleteSkill(id: string): Promise<void> {
  return call('deleteSkill', id);
}
export async function listSkillUsageRecords(skillId?: string): Promise<SkillUsageRecord[]> {
  return skillId === undefined
    ? call('listSkillUsageRecords')
    : call('listSkillUsageRecords', skillId);
}
export async function syncSkillFeedbackScores(): Promise<Skill[]> {
  return call('syncSkillFeedbackScores');
}
export async function createSkillUsageRecord(

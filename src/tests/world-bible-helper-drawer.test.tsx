...
vi.mock('../lib/world-client', () => ({
  listCharacters: resolved(),
  listLocations: resolved(),
  listItems: resolved(),
  listTimelineEvents: resolved(),
  listFactions: resolved(),
  listPowerLevels: resolved(),
  listEntityRelationshipsClient: resolved(),
  createCharacter: resolved(),
  updateCharacter: resolved(),
  deleteCharacter: resolved(),
  createLocation: resolved(),
  updateLocation: resolved(),
  deleteLocation: resolved(),
  createItem: resolved(),
  updateItem: resolved(),
  deleteItem: resolved(),
  createFaction: resolved(),
  updateFaction: resolved(),
  deleteFaction: resolved(),
  createPowerLevel: resolved(),
  updatePowerLevel: resolved(),
  deletePowerLevel: resolved(),
  createTimelineEvent: resolved(),
  updateTimelineEvent: resolved(),
  deleteTimelineEvent: resolved(),
...
vi.mock('../components/ContinuationOverviewPanel', () => ({
  ContinuationOverviewPanel: () => <div>overview</div>,
}));
vi.mock('../components/ContinuationPackView', () => ({
  ContinuationPackView: () => <div>packs</div>,
}));
vi.mock('../components/StoryContractPanel', () => ({ StoryContractPanel: () => <div /> }));
vi.mock('../components/world-bible/CharactersTab', () => ({
  CharactersTab: () => <div>characters</div>,
}));
...
vi.mock('../components/world-bible/RelationshipFormDialog', () => ({
  RelationshipFormDialog: () => null,
}));
